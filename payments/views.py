...
class PaymentView(APIView):
    ...
    def get(self, request):
        ...
        return Response({'token': payment.token, 'callback_url': 'https://my-site/payments/pay/'})
    ...
    def post(self, request):
        ...
        Subscription.objects.create(
            ...
            expire_at=timezone.now() + timezone.timedelta(days=payment.package.duration.days)
        )

        return Response({'detail': 'Payment paid successfully!'})
